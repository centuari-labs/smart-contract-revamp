...
/// @title UpgradeBalanceLedger
/// @notice Schedules and executes a BalanceLedger proxy upgrade via TimelockController.
...
///        # Schedule
///        forge script script/UpgradeBalanceLedger.s.sol:UpgradeBalanceLedger \
...
///          $TIMELOCK $PROXY_ADMIN $PROXY "deployments/scheduled-upgrade-BalanceLedger-0x....json" \
///          --broadcast --rpc-url $RPC_URL
contract UpgradeBalanceLedger is UpgradeScriptBase {
    function _contractName() internal pure override returns (string memory) {
        return "BalanceLedger";
    }

    function _deployNewImplementation() internal override returns (address) {
        return address(new BalanceLedger());
    }
}
