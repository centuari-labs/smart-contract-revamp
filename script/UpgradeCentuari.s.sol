...
/// @notice Schedules and executes a Centuari proxy upgrade via TimelockController.
...
///        # Schedule
///        forge script script/UpgradeCentuari.s.sol:UpgradeCentuari \
...
///          $TIMELOCK $PROXY_ADMIN $PROXY "deployments/scheduled-upgrade-Centuari-0x....json" \
///          --broadcast --rpc-url $RPC_URL
///
///        # Cancel
///        forge script script/UpgradeCentuari.s.sol:UpgradeCentuari \
///          --sig "runCancel(address,string)" \
///          $TIMELOCK "deployments/scheduled-upgrade-Centuari-0x....json" \
///          --broadcast --rpc-url $RPC_URL
contract UpgradeCentuari is UpgradeScriptBase {
    function _contractName() internal pure override returns (string memory) {
        return "Centuari";
    }

    function _deployNewImplementation() internal override returns (address) {
        return address(new Centuari());
    }
}
